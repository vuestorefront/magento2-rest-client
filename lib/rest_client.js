...
module.exports.RestClient = function (options) {
    ...
    function apiCall(request_data, request_token = '', attachResponseCode = false) {
        /* eslint no-undef: off*/        
...
//                resolve(bodyCamelized);
                if (['number', 'string', 'boolean'].includes(typeof body) || !attachResponseCode) {
                    resolve(body)
                } else {
                    resolve({
                        ...body,
    ...
    instance.get = function (resourceUrl, request_token = '', responseCode = false) {
        var request_data = {
            url: createUrl(resourceUrl),
            method: 'GET'
        };
        return apiCall(request_data, request_token, responseCode);
    }
    ...
    instance.post = function (resourceUrl, data, request_token = '', responseCode = false) {
        var request_data = {
            url: createUrl(resourceUrl),
            method: 'POST',
            body: data
    ...
    instance.put = function (resourceUrl, data, request_token = '', responseCode = false) {
        var request_data = {
            url: createUrl(resourceUrl),
            method: 'PUT',
            body: data
    ...
    instance.delete = function (resourceUrl, request_token = '', responseCode = false) {
        var request_data = {
            url: createUrl(resourceUrl),
            method: 'DELETE'
        };
